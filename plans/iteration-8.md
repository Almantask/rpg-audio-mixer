## Iteration 8 — Trash Screen & Credits Integration (Simple)
...
- `app/src/androidTest/assets/features/view_credits.feature` (scenarios tagged `@iter8`: VAULT OF ECHOES button & navigation)
