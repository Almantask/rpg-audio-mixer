    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                modifier = Modifier.testTag("NewSceneFAB")
            ) {
                Icon(
                    imageVector = Icons.Default.Add,
                    contentDescription = "Add New Scene",
            ...
            when (val state = uiState) {
                ...
                is ScenesUiState.Success -> {
                    if (state.scenes.isEmpty()) {
                        EmptyScenesState(
                            onCreateScene = { viewModel.showCreateDialog() },
                            modifier = Modifier.align(Alignment.Center)
                        )
                    } else {
                        ScenesList(
...
private fun EmptyScenesState(
    ...
    Column(
        ...
        Text(
            text = "Create your first scene to set the atmosphere",
