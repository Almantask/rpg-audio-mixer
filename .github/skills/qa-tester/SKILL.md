...
```bash
.\.github\skills\qa-tester\scripts\run_acceptance_tests.ps1 -FeaturePath "features/your_feature.feature"
```
...
- To run a specific feature: `.\.github\skills\qa-tester\scripts\run_acceptance_tests.ps1 -FeaturePath "features/your_feature.feature"`
